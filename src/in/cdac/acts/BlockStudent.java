	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (session != null && !session.equals("")) {
			...
			try {
				...
				pst = connection
						.prepareStatement("UPDATE ePariksha_Student_Login SET stud_Login_Flag = ?  where stud_PRN in ("
								+ strStudId + ")");
				pst.setBoolean(1, bStudentStatus);
